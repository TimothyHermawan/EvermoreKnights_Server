...
public class GetPlayerTransactionReceipts extends HttpServlet
{
    	...
    	// GET THE REQUEST DATA
    	  ...
    	  try {
    		  ...
    		  if(dataRequest != null) {
        		  ...
        		  // EXECUTE ACTION
    			  result = (BasicServletResponse) myExtension.handleInternalMessage(ServletCommand.GET_PLAYER_CURRENCY_RECEIPTS, dataRequest);
    		  }else {
    			  result.status = 0;
