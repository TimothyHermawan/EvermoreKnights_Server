...
public class References {
	...
	public static class DatabaseCollection{
		...
		public static String GameAsset_Character = "gameasset_character";  
		public static String GameAsset_BodyPart = "gameasset_bodypart";  
	}
	...
	public static class SmartfoxCMD{
		...
		public static String Prefix_Character = "character";
		...
		public static String Character_GenerateCharacterData = "generateCharacaterData";
	}
